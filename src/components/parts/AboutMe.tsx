const AboutMe = () => {
    return <div className="about-me flex max-w-2xl flex-col gap-12 font-Preahvihear text-white">
        <div>
            <p className="text-2xl">I am a Software Engineer. <span className="animate-ticker">|</span></p>
